...
class Filter:
    ...
    DateRangeFrom_xpath = "//input[@id='mat-date-range-input-1']"
    ...
    def DateRangeIp(self):
        self.clickOnDate = self.driver.find_element_by_xpath(self.Date_Table_xpath).click()
    ...
    def Savebutton(self):
        self.clickbutton = self.driver.find_element_by_xpath(self.btnSave_xpath).click()

        time.sleep(3)
        self.driver.execute_script("arguments[0].click();", self.listFirmType)
